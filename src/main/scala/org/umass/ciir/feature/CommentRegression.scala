...
class CommentRegression(featureGen: FeatureGenerator)
{
  ...
  val weights : Map[Int, Double] = Map(0->33.631177, 5->0.823592, 10->6.025757, 1->71.897880, 6->85.091818,
    9->28.817287, 13->51.130588, 2->1.082153, 12->7.916237,
    7->28.182866, 3->6.058194, 11->0.000000, 8->24.682272, 4->8.500743)
